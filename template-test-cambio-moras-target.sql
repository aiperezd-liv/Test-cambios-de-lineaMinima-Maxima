/***********************************************************************************************************************
  ...
  POBLACIÓN EXCLUSIVA: INGRESOS >= 4K Y LÍNEA DE CRÉDITO ORIGINAL < 4K
***********************************************************************************************************************/
...
------------------------------------------------------------------------------------------------------------------------
-- MÓDULO 3.5: ACUTACIÓN FILTRADA DEL UNIVERSO (SÓLO CUENTAS IMPACTADAS POR LA ESTRATEGIA)
------------------------------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------------------------------------------------------
-- MÓDULO 4: CÁLCULO DE MÉTRICAS PROMEDIO GRUPALES (CALCULADAS SÓLO CON LA POBLACIÓN IMPACTADA)
------------------------------------------------------------------------------------------------------------------------
CALC_SDO_PROM AS (
  SELECT 
    a.BR_HIT_DES,
